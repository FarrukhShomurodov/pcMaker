...
class OrderController extends Controller
{
    ...
    public function changeStatus(Request $request, Order $order)
    {
        ...
        // Текст сообщения в зависимости от статуса заказа
        ...
        // Отправляем сообщение о статусе заказа
        $telegram->sendMessage([
            'chat_id' => $order->user->chat_id,
            'text' => $text,
        ]);

        // Если статус не "cancelled", отправляем геолокацию
        ...
        // Подготовка деталей заказа в зависимости от типа
        $orderDetails = [];

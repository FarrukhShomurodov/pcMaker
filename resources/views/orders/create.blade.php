            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        ...
                        @endif
                        <form action="{{ route('product.items.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    success: function (response) {
                        ...
                        if (response.length > 0) {
                            response.forEach(function (subCategory) {
                                $('#product_sub_category_select').append(`<option value="${subCategory.id}">${subCategory.name}</option>`
                                );
                            });
                        } else {
